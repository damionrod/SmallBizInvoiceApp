-- V61.79E rollback only.
-- Restores the two function definitions that existed immediately before V61.79E.
-- This does not delete schedules, assignments, or other business data.
begin;
