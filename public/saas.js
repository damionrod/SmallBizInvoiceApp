(() => {
  ...
  async function enter(session){
    ...
    if(!state.loadedApp){
      ...
      await window.FinloCore.loader.loadScriptsSequentially(['app.js?v=61.97-performance-fixes','schedule.js?v=61.98J-drag-drop-fix','dashboard.js?v=61.89-voided-bills','job-costing.js?v=61.72A.1-gst','job-profitability.js?v=61.71','expenses.js?v=61.90f-inline-review','purchase-review.js?v=61.90g-discounts','payroll-nz-holidays.js?v=61.73-P3.1','payroll-nz-statutory-leave.js?v=61.73-P4B.1','payroll-nz-public-holidays.js?v=61.73-P5B.1','payroll-nz-final-pay.js?v=61.73-P6C.2','payroll-nz-tax.js?v=61.73-P7','payroll.js?v=61.97-performance-fixes','financials.js?v=61.98I-gst-actions','accountant-centre.js?v=61.90g-discounts','bank-reconciliation.js?v=61.97-performance-fixes']);await bindAfterAppLoad();refreshUsage();const mw=Number(localStorage.getItem('v22_migration_warning')||0);if(mw)console.warn(`${mw} legacy browser record(s) remain safely stored locally; cloud migration can be reviewed from account support if needed.`);
    }
  }
